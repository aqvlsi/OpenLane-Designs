...
set ::env(DESIGN_CONFIG) "/openlane/designs/design_mux/config.tcl"
set ::env(DESIGN_DIR) "/openlane/designs/design_mux"
...
set ::env(GLB_CFG_FILE) "/openlane/designs/design_mux/runs/run2/config.tcl"
...
set ::env(LIB_CTS) "/openlane/designs/design_mux/runs/run1/tmp/cts/cts.lib"
set ::env(LIB_CTS_FASTEST) "/openlane/designs/design_mux/runs/run1/tmp/cts/cts-fastest.lib"
set ::env(LIB_CTS_SLOWEST) "/openlane/designs/design_mux/runs/run1/tmp/cts/cts-slowest.lib"
...
set ::env(LIB_SYNTH) "/openlane/designs/design_mux/runs/run2/tmp/synthesis/trimmed.lib"
set ::env(LIB_SYNTH_COMPLETE) "/root/.volare/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib"
set ::env(LIB_SYNTH_COMPLETE_NO_PG) "/openlane/designs/design_mux/runs/run2/tmp/synthesis/2-sky130_fd_sc_hd__tt_025C_1v80.no_pg.lib"
set ::env(LIB_SYNTH_MERGED) "/openlane/designs/design_mux/runs/run2/tmp/synthesis/merged.lib"
set ::env(LIB_SYNTH_NO_PG) "/openlane/designs/design_mux/runs/run2/tmp/synthesis/2-trimmed.no_pg.lib"
...
set ::env(LOGS_DIR) "/openlane/designs/design_mux/runs/run2/logs"
...
set ::env(MERGED_LEF) "/openlane/designs/design_mux/runs/run2/tmp/merged.nom.lef"
set ::env(MERGED_LEF_MAX) "/openlane/designs/design_mux/runs/run2/tmp/merged.max.lef"
set ::env(MERGED_LEF_MIN) "/openlane/designs/design_mux/runs/run2/tmp/merged.min.lef"
...
set ::env(REPORTS_DIR) "/openlane/designs/design_mux/runs/run2/reports"
set ::env(RESULTS_DIR) "/openlane/designs/design_mux/runs/run2/results"
...
set ::env(RUN_CTS) "1"
set ::env(RUN_CVC) "1"
set ::env(RUN_DIR) "/openlane/designs/design_mux/runs/run2"
set ::env(RUN_DRT) "1"
...
set ::env(RUN_TAG) "run2"
set ::env(RUN_TAP_DECAP_INSERTION) "1"
set ::env(SAVE_NETLIST) "/openlane/designs/design_mux/runs/run2/results/synthesis/design_mux.v"
set ::env(SCLPATH) "/root/.volare/sky130A/sky130_fd_sc_hd"
set ::env(SIGNOFF_SDC_FILE) "/openlane/scripts/base.sdc"
set ::env(SPEF_EXTRACTOR) "openrcx"
set ::env(START_TIME) "2024.05.26_14.56.37"
...
set ::env(TMP_DIR) "/openlane/designs/design_mux/runs/run2/tmp"
set ::env(TOP_MARGIN_MULT) "4"
set ::env(TRACKS_INFO_FILE) "/root/.volare/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tracks.info"
set ::env(TRACKS_INFO_FILE_PROCESSED) "/openlane/designs/design_mux/runs/run2/tmp/routing/config.tracks"
...
set ::env(cts_logs) "/openlane/designs/design_mux/runs/run2/logs/cts"
set ::env(cts_reports) "/openlane/designs/design_mux/runs/run2/reports/cts"
set ::env(cts_results) "/openlane/designs/design_mux/runs/run2/results/cts"
set ::env(cts_tmpfiles) "/openlane/designs/design_mux/runs/run2/tmp/cts"
set ::env(floorplan_logs) "/openlane/designs/design_mux/runs/run2/logs/floorplan"
set ::env(floorplan_reports) "/openlane/designs/design_mux/runs/run2/reports/floorplan"
set ::env(floorplan_results) "/openlane/designs/design_mux/runs/run2/results/floorplan"
set ::env(floorplan_tmpfiles) "/openlane/designs/design_mux/runs/run2/tmp/floorplan"
set ::env(placement_logs) "/openlane/designs/design_mux/runs/run2/logs/placement"
set ::env(placement_reports) "/openlane/designs/design_mux/runs/run2/reports/placement"
set ::env(placement_results) "/openlane/designs/design_mux/runs/run2/results/placement"
set ::env(placement_tmpfiles) "/openlane/designs/design_mux/runs/run2/tmp/placement"
set ::env(routing_logs) "/openlane/designs/design_mux/runs/run2/logs/routing"
set ::env(routing_reports) "/openlane/designs/design_mux/runs/run2/reports/routing"
set ::env(routing_results) "/openlane/designs/design_mux/runs/run2/results/routing"
set ::env(routing_tmpfiles) "/openlane/designs/design_mux/runs/run2/tmp/routing"
set ::env(signoff_logs) "/openlane/designs/design_mux/runs/run2/logs/signoff"
set ::env(signoff_reports) "/openlane/designs/design_mux/runs/run2/reports/signoff"
set ::env(signoff_results) "/openlane/designs/design_mux/runs/run2/results/signoff"
set ::env(signoff_tmpfiles) "/openlane/designs/design_mux/runs/run2/tmp/signoff"
set ::env(synth_report_prefix) "/openlane/designs/design_mux/runs/run2/reports/synthesis/2-synthesis"
set ::env(synthesis_logs) "/openlane/designs/design_mux/runs/run2/logs/synthesis"
set ::env(synthesis_reports) "/openlane/designs/design_mux/runs/run2/reports/synthesis"
set ::env(synthesis_results) "/openlane/designs/design_mux/runs/run2/results/synthesis"
set ::env(synthesis_tmpfiles) "/openlane/designs/design_mux/runs/run2/tmp/synthesis"
set ::env(timer_start) "1716735397"
