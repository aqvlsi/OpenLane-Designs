...
set ::env(GLB_CFG_FILE) "/openlane/designs/design_mux/runs/run1/config.tcl"
...
set ::env(LIB_SYNTH) "/openlane/designs/design_mux/runs/run1/tmp/synthesis/trimmed.lib"
set ::env(LIB_SYNTH_COMPLETE) "/root/.volare/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib"
set ::env(LIB_SYNTH_COMPLETE_NO_PG) "/openlane/designs/design_mux/runs/run1/tmp/synthesis/1-sky130_fd_sc_hd__tt_025C_1v80.no_pg.lib"
set ::env(LIB_SYNTH_MERGED) "/openlane/designs/design_mux/runs/run1/tmp/synthesis/merged.lib"
set ::env(LIB_SYNTH_NO_PG) "/openlane/designs/design_mux/runs/run1/tmp/synthesis/1-trimmed.no_pg.lib"
...
set ::env(LOGS_DIR) "/openlane/designs/design_mux/runs/run1/logs"
...
set ::env(MERGED_LEF) "/openlane/designs/design_mux/runs/run1/tmp/merged.nom.lef"
set ::env(MERGED_LEF_MAX) "/openlane/designs/design_mux/runs/run1/tmp/merged.max.lef"
set ::env(MERGED_LEF_MIN) "/openlane/designs/design_mux/runs/run1/tmp/merged.min.lef"
...
set ::env(REPORTS_DIR) "/openlane/designs/design_mux/runs/run1/reports"
set ::env(RESULTS_DIR) "/openlane/designs/design_mux/runs/run1/results"
...
set ::env(RUN_CTS) "1"
set ::env(RUN_CVC) "1"
set ::env(RUN_DIR) "/openlane/designs/design_mux/runs/run1"
set ::env(RUN_DRT) "1"
...
set ::env(SAVE_NETLIST) "/openlane/designs/design_mux/runs/run1/results/synthesis/design_mux.v"
set ::env(SCLPATH) "/root/.volare/sky130A/sky130_fd_sc_hd"
set ::env(SIGNOFF_SDC_FILE) "/openlane/scripts/base.sdc"
set ::env(SPEF_EXTRACTOR) "openrcx"
set ::env(START_TIME) "2024.05.26_14.31.45"
...
set ::env(TMP_DIR) "/openlane/designs/design_mux/runs/run1/tmp"
set ::env(TOP_MARGIN_MULT) "4"
set ::env(TRACKS_INFO_FILE) "/root/.volare/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tracks.info"
set ::env(TRACKS_INFO_FILE_PROCESSED) "/openlane/designs/design_mux/runs/run1/tmp/routing/config.tracks"
...
set ::env(cts_logs) "/openlane/designs/design_mux/runs/run1/logs/cts"
set ::env(cts_reports) "/openlane/designs/design_mux/runs/run1/reports/cts"
set ::env(cts_results) "/openlane/designs/design_mux/runs/run1/results/cts"
set ::env(cts_tmpfiles) "/openlane/designs/design_mux/runs/run1/tmp/cts"
set ::env(floorplan_logs) "/openlane/designs/design_mux/runs/run1/logs/floorplan"
set ::env(floorplan_reports) "/openlane/designs/design_mux/runs/run1/reports/floorplan"
set ::env(floorplan_results) "/openlane/designs/design_mux/runs/run1/results/floorplan"
set ::env(floorplan_tmpfiles) "/openlane/designs/design_mux/runs/run1/tmp/floorplan"
set ::env(placement_logs) "/openlane/designs/design_mux/runs/run1/logs/placement"
set ::env(placement_reports) "/openlane/designs/design_mux/runs/run1/reports/placement"
set ::env(placement_results) "/openlane/designs/design_mux/runs/run1/results/placement"
set ::env(placement_tmpfiles) "/openlane/designs/design_mux/runs/run1/tmp/placement"
set ::env(routing_logs) "/openlane/designs/design_mux/runs/run1/logs/routing"
set ::env(routing_reports) "/openlane/designs/design_mux/runs/run1/reports/routing"
set ::env(routing_results) "/openlane/designs/design_mux/runs/run1/results/routing"
set ::env(routing_tmpfiles) "/openlane/designs/design_mux/runs/run1/tmp/routing"
set ::env(signoff_logs) "/openlane/designs/design_mux/runs/run1/logs/signoff"
set ::env(signoff_reports) "/openlane/designs/design_mux/runs/run1/reports/signoff"
set ::env(signoff_results) "/openlane/designs/design_mux/runs/run1/results/signoff"
set ::env(signoff_tmpfiles) "/openlane/designs/design_mux/runs/run1/tmp/signoff"
set ::env(synth_report_prefix) "/openlane/designs/design_mux/runs/run1/reports/synthesis/1-synthesis"
set ::env(synthesis_logs) "/openlane/designs/design_mux/runs/run1/logs/synthesis"
set ::env(synthesis_reports) "/openlane/designs/design_mux/runs/run1/reports/synthesis"
set ::env(synthesis_results) "/openlane/designs/design_mux/runs/run1/results/synthesis"
set ::env(synthesis_tmpfiles) "/openlane/designs/design_mux/runs/run1/tmp/synthesis"
set ::env(timer_start) "1716733904"
