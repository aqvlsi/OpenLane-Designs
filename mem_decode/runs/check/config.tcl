...
set ::env(CURRENT_DEF) /openlane/designs/mem_decode/runs/check/results/floorplan/mem_decode.def
set ::env(CURRENT_GUIDE) "0"
set ::env(CURRENT_INDEX) 8
set ::env(CURRENT_NETLIST) /openlane/designs/mem_decode/runs/check/results/synthesis/mem_decode.v
set ::env(CURRENT_ODB) /openlane/designs/mem_decode/runs/check/results/floorplan/mem_decode.odb
set ::env(CURRENT_POWERED_NETLIST) "0"
set ::env(CURRENT_SDC) /openlane/designs/mem_decode/runs/check/tmp/floorplan/5-initial_fp.sdc
...
set ::env(GLB_CFG_FILE) "/openlane/designs/mem_decode/runs/check/config.tcl"
...
set ::env(LIB_CTS) "/openlane/designs/check/runs/checkrun/tmp/cts/cts.lib"
set ::env(LIB_CTS_FASTEST) "/openlane/designs/check/runs/checkrun/tmp/cts/cts-fastest.lib"
set ::env(LIB_CTS_SLOWEST) "/openlane/designs/check/runs/checkrun/tmp/cts/cts-slowest.lib"
...
set ::env(LIB_SYNTH) "/root/.volare/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib"
set ::env(LIB_SYNTH_COMPLETE) "/root/.volare/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib"
set ::env(LIB_SYNTH_COMPLETE_NO_PG) "/openlane/designs/check/runs/checkrun/tmp/synthesis/2-sky130_fd_sc_hd__tt_025C_1v80.no_pg.lib"
set ::env(LIB_SYNTH_MERGED) "/openlane/designs/check/runs/checkrun/tmp/synthesis/merged.lib"
set ::env(LIB_SYNTH_NO_PG) "/openlane/designs/check/runs/checkrun/tmp/synthesis/2-trimmed.no_pg.lib"
...
set ::env(LOGS_DIR) "/openlane/designs/mem_decode/runs/check/logs"
...
set ::env(MERGED_LEF) "/openlane/designs/check/runs/checkrun/tmp/merged.nom.lef"
set ::env(MERGED_LEF_MAX) "/openlane/designs/check/runs/checkrun/tmp/merged.max.lef"
set ::env(MERGED_LEF_MIN) "/openlane/designs/check/runs/checkrun/tmp/merged.min.lef"
...
set ::env(REPORTS_DIR) "/openlane/designs/mem_decode/runs/check/reports"
set ::env(RESULTS_DIR) "/openlane/designs/mem_decode/runs/check/results"
...
set ::env(RUN_CTS) "1"
set ::env(RUN_CVC) "1"
set ::env(RUN_DIR) "/openlane/designs/mem_decode/runs/check"
set ::env(RUN_DRT) "1"
...
set ::env(START_TIME) "2024.05.21_06.02.27"
...
set ::env(TMP_DIR) "/openlane/designs/mem_decode/runs/check/tmp"
set ::env(TOP_MARGIN_MULT) "4"
set ::env(TRACKS_INFO_FILE) "/root/.volare/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tracks.info"
set ::env(TRACKS_INFO_FILE_PROCESSED) "/openlane/designs/check/runs/checkrun/tmp/routing/config.tracks"
...
set ::env(cts_logs) "/openlane/designs/mem_decode/runs/check/logs/cts"
set ::env(cts_reports) "/openlane/designs/mem_decode/runs/check/reports/cts"
set ::env(cts_results) "/openlane/designs/mem_decode/runs/check/results/cts"
set ::env(cts_tmpfiles) "/openlane/designs/mem_decode/runs/check/tmp/cts"
set ::env(floorplan_logs) "/openlane/designs/mem_decode/runs/check/logs/floorplan"
set ::env(floorplan_reports) "/openlane/designs/mem_decode/runs/check/reports/floorplan"
set ::env(floorplan_results) "/openlane/designs/mem_decode/runs/check/results/floorplan"
set ::env(floorplan_tmpfiles) "/openlane/designs/mem_decode/runs/check/tmp/floorplan"
set ::env(placement_logs) "/openlane/designs/mem_decode/runs/check/logs/placement"
set ::env(placement_reports) "/openlane/designs/mem_decode/runs/check/reports/placement"
set ::env(placement_results) "/openlane/designs/mem_decode/runs/check/results/placement"
set ::env(placement_tmpfiles) "/openlane/designs/mem_decode/runs/check/tmp/placement"
set ::env(routing_logs) "/openlane/designs/mem_decode/runs/check/logs/routing"
set ::env(routing_reports) "/openlane/designs/mem_decode/runs/check/reports/routing"
set ::env(routing_results) "/openlane/designs/mem_decode/runs/check/results/routing"
set ::env(routing_tmpfiles) "/openlane/designs/mem_decode/runs/check/tmp/routing"
set ::env(signoff_logs) "/openlane/designs/mem_decode/runs/check/logs/signoff"
set ::env(signoff_reports) "/openlane/designs/mem_decode/runs/check/reports/signoff"
set ::env(signoff_results) "/openlane/designs/mem_decode/runs/check/results/signoff"
set ::env(signoff_tmpfiles) "/openlane/designs/mem_decode/runs/check/tmp/signoff"
set ::env(synth_report_prefix) "/openlane/designs/check/runs/checkrun/reports/synthesis/2-synthesis"
set ::env(synthesis_logs) "/openlane/designs/mem_decode/runs/check/logs/synthesis"
set ::env(synthesis_reports) "/openlane/designs/mem_decode/runs/check/reports/synthesis"
set ::env(synthesis_results) "/openlane/designs/mem_decode/runs/check/results/synthesis"
set ::env(synthesis_tmpfiles) "/openlane/designs/mem_decode/runs/check/tmp/synthesis"
set ::env(timer_start) "1716271347"
set ::env(SYNTH_OPT) "0"
set ::env(PL_INIT_COEFF) "0.00002"
set ::env(PL_IO_ITER) "5"
