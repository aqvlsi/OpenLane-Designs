# Saved State
set ::env(BASE_SDC_FILE) "/openlane/designs/mem_decode/src/mem_decode.sdc"
...
set ::env(CORE_AREA) "5.52 10.88 194.12 587.52"
set ::env(CORE_HEIGHT) "576.64"
...
set ::env(CURRENT_DEF) "/openlane/designs/mem_decode/runs/decoder/results/floorplan/mem_decode.def"
set ::env(CURRENT_GUIDE) "0"
set ::env(CURRENT_INDEX) "7"
set ::env(CURRENT_LIB) "/openlane/designs/mem_decode/runs/decoder/results/synthesis/mem_decode.lib"
set ::env(CURRENT_NETLIST) "/openlane/designs/mem_decode/runs/decoder/results/synthesis/mem_decode.v"
set ::env(CURRENT_ODB) "/openlane/designs/mem_decode/runs/decoder/results/floorplan/mem_decode.odb"
set ::env(CURRENT_POWERED_NETLIST) "0"
set ::env(CURRENT_SDC) "/openlane/designs/mem_decode/runs/decoder/tmp/floorplan/3-initial_fp.sdc"
set ::env(CURRENT_SDF) "/openlane/designs/mem_decode/runs/decoder/results/synthesis/mem_decode.sdf"
...
set ::env(DESIGN_CONFIG) "/openlane/designs/mem_decode/config.tcl"
set ::env(DESIGN_DIR) "/openlane/designs/mem_decode"
set ::env(DESIGN_NAME) "mem_decode"
set ::env(DETAILED_ROUTER) "tritonroute"
set ::env(DIE_AREA) "0.0 0.0 200.0 600.0"
...
set ::env(FP_PIN_ORDER_CFG) "/openlane/designs/mem_decode/pin_order.cfg"
...
set ::env(GLB_CFG_FILE) "/openlane/designs/mem_decode/runs/decoder/config.tcl"
...
set ::env(GRT_CONGESTION_REPORT_FILE) "/openlane/designs/mem_decode/runs/decoder/tmp/routing/resizer-routing-design-congestion.rpt"
...
set ::env(LAST_TIMING_REPORT_TAG) "/openlane/designs/mem_decode/runs/decoder/reports/synthesis/2-syn_sta"
set ::env(LEC_ENABLE) "0"
set ::env(LEFT_MARGIN_MULT) "12"
set ::env(LIB_CTS) "/openlane/designs/mem_decode/runs/decoder/tmp/cts/cts.lib"
set ::env(LIB_CTS_FASTEST) "/openlane/designs/mem_decode/runs/decoder/tmp/cts/cts-fastest.lib"
set ::env(LIB_CTS_SLOWEST) "/openlane/designs/mem_decode/runs/decoder/tmp/cts/cts-slowest.lib"
...
set ::env(LIB_SYNTH) "/openlane/designs/mem_decode/runs/decoder/tmp/synthesis/trimmed.lib"
set ::env(LIB_SYNTH_COMPLETE) "/root/.volare/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib"
set ::env(LIB_SYNTH_COMPLETE_NO_PG) "/openlane/designs/mem_decode/runs/decoder/tmp/synthesis/2-sky130_fd_sc_hd__tt_025C_1v80.no_pg.lib"
set ::env(LIB_SYNTH_MERGED) "/openlane/designs/mem_decode/runs/decoder/tmp/synthesis/merged.lib"
set ::env(LIB_SYNTH_NO_PG) "/openlane/designs/mem_decode/runs/decoder/tmp/synthesis/2-trimmed.no_pg.lib"
...
set ::env(LOGS_DIR) "/openlane/designs/mem_decode/runs/decoder/logs"
...
set ::env(MERGED_LEF) "/openlane/designs/mem_decode/runs/decoder/tmp/merged.nom.lef"
set ::env(MERGED_LEF_MAX) "/openlane/designs/mem_decode/runs/decoder/tmp/merged.max.lef"
set ::env(MERGED_LEF_MIN) "/openlane/designs/mem_decode/runs/decoder/tmp/merged.min.lef"
...
set ::env(PNR_SDC_FILE) "/openlane/designs/mem_decode/src/mem_decode.sdc"
...
set ::env(REPORTS_DIR) "/openlane/designs/mem_decode/runs/decoder/reports"
set ::env(RESULTS_DIR) "/openlane/designs/mem_decode/runs/decoder/results"
...
set ::env(RUN_CTS) "1"
set ::env(RUN_CVC) "1"
set ::env(RUN_DIR) "/openlane/designs/mem_decode/runs/decoder"
set ::env(RUN_DRT) "1"
...
set ::env(RUN_TAG) "decoder"
set ::env(RUN_TAP_DECAP_INSERTION) "1"
set ::env(SAVE_DEF) "/openlane/designs/mem_decode/runs/decoder/tmp/7-mem_decode.def"
set ::env(SAVE_DIR) "/openlane/designs/mem_decode/runs/decoder/tmp/routing"
set ::env(SAVE_NETLIST) "/openlane/designs/mem_decode/runs/decoder/tmp/7-mem_decode.nl.v"
set ::env(SAVE_ODB) "/openlane/designs/mem_decode/runs/decoder/tmp/7-mem_decode.odb"
set ::env(SAVE_POWERED_NETLIST) "/openlane/designs/mem_decode/runs/decoder/tmp/7-mem_decode.pnl.v"
set ::env(SAVE_SDC) "/openlane/designs/mem_decode/runs/decoder/tmp/7-mem_decode.sdc"
set ::env(SCLPATH) "/root/.volare/sky130A/sky130_fd_sc_hd"
set ::env(SIGNOFF_SDC_FILE) "/openlane/designs/mem_decode/src/mem_decode.sdc"
set ::env(SPEF_EXTRACTOR) "openrcx"
set ::env(START_TIME) "2024.05.21_05.19.19"
...
set ::env(TMP_DIR) "/openlane/designs/mem_decode/runs/decoder/tmp"
set ::env(TOP_MARGIN_MULT) "4"
set ::env(TRACKS_INFO_FILE) "/root/.volare/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tracks.info"
set ::env(TRACKS_INFO_FILE_PROCESSED) "/openlane/designs/mem_decode/runs/decoder/tmp/routing/config.tracks"
...
set ::env(VERILOG_FILES) "/openlane/designs/mem_decode/src/mem_decode.v"
set ::env(WRITE_VIEWS_NO_GLOBAL_CONNECT) "0"
set ::env(YOSYS_REWRITE_VERILOG) "0"
set ::env(cts_logs) "/openlane/designs/mem_decode/runs/decoder/logs/cts"
set ::env(cts_reports) "/openlane/designs/mem_decode/runs/decoder/reports/cts"
set ::env(cts_results) "/openlane/designs/mem_decode/runs/decoder/results/cts"
set ::env(cts_tmpfiles) "/openlane/designs/mem_decode/runs/decoder/tmp/cts"
set ::env(floorplan_logs) "/openlane/designs/mem_decode/runs/decoder/logs/floorplan"
set ::env(floorplan_reports) "/openlane/designs/mem_decode/runs/decoder/reports/floorplan"
set ::env(floorplan_results) "/openlane/designs/mem_decode/runs/decoder/results/floorplan"
set ::env(floorplan_tmpfiles) "/openlane/designs/mem_decode/runs/decoder/tmp/floorplan"
set ::env(fp_report_prefix) "/openlane/designs/mem_decode/runs/decoder/reports/floorplan/3-initial_fp"
set ::env(placement_logs) "/openlane/designs/mem_decode/runs/decoder/logs/placement"
set ::env(placement_reports) "/openlane/designs/mem_decode/runs/decoder/reports/placement"
set ::env(placement_results) "/openlane/designs/mem_decode/runs/decoder/results/placement"
set ::env(placement_tmpfiles) "/openlane/designs/mem_decode/runs/decoder/tmp/placement"
set ::env(routing_logs) "/openlane/designs/mem_decode/runs/decoder/logs/routing"
set ::env(routing_reports) "/openlane/designs/mem_decode/runs/decoder/reports/routing"
set ::env(routing_results) "/openlane/designs/mem_decode/runs/decoder/results/routing"
set ::env(routing_tmpfiles) "/openlane/designs/mem_decode/runs/decoder/tmp/routing"
set ::env(signoff_logs) "/openlane/designs/mem_decode/runs/decoder/logs/signoff"
set ::env(signoff_reports) "/openlane/designs/mem_decode/runs/decoder/reports/signoff"
set ::env(signoff_results) "/openlane/designs/mem_decode/runs/decoder/results/signoff"
set ::env(signoff_tmpfiles) "/openlane/designs/mem_decode/runs/decoder/tmp/signoff"
set ::env(synth_report_prefix) "/openlane/designs/mem_decode/runs/decoder/reports/synthesis/2-synthesis"
set ::env(synthesis_logs) "/openlane/designs/mem_decode/runs/decoder/logs/synthesis"
set ::env(synthesis_reports) "/openlane/designs/mem_decode/runs/decoder/reports/synthesis"
set ::env(synthesis_results) "/openlane/designs/mem_decode/runs/decoder/results/synthesis"
set ::env(synthesis_tmpfiles) "/openlane/designs/mem_decode/runs/decoder/tmp/synthesis"
set ::env(timer_start) "1716268758"
